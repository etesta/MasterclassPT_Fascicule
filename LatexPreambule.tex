...
% \newtheorem{theo}{Théoréme}   % Environnement theoreme
% \usepackage{amsfonts}
\usepackage{graphicx}
\usepackage{listings,comment}
\usepackage{tabularx} % Pour avoir des tableaux d'une largeur bien définie
...
\usepackage[squaren,Gray]{SIunits} % pour avoir de jolies unités
\usepackage{enumitem}
\usepackage{hyperref}
\usepackage{color}
\usepackage{xifthen}
...
% compteur pour numéroter les questions à la suite dans un même TP.
